...
exports.seed = async (knex) => {
  ...
  const events = [
    ...
    },
    {
      id: 13,
      user_id: 3,
      date_created: "2025-05-17T07:00:00Z",
      is_issue: false,
      images: [
        "https://www.endurancesportswire.com/wp-content/uploads/2011/04/BK-Bridge-Photo.jpeg",
      ],
      title: "RBC Brooklyn Half Marathon",
      lat_location: 40.6602,
      long_location: -73.969,
      ...
      status: true,
      description:
        "Join thousands of runners in one of the largest half marathons in the U.S., starting in Prospect Park.",
    },
    {
      id: 14,
      user_id: 4,
      date_created: "2025-05-10T12:00:00Z",
      is_issue: false,
      images: [
        "https://i0.wp.com/thecitylife.org/wp-content/uploads/2025/04/DA5_3073_051323-Highbridge-1024x683.jpg?strip=info&w=2000&ssl=1",
      ],
      title: "Urban Wildlife Festival",
      lat_location: 40.8164,
      long_location: -73.907,
      address: "St. Mary's Park, Bronx, NY 10455",
      borough: "Bronx",
      zipcode: "10455",
      email: "wildlife@example.com",
      phone: "555-555-1414",
      status: false, // Marked as inactive
      description:
        "Discover abundant wildlife at this free family event featuring live animals and educational activities.",
    },
    {
      id: 15,
      user_id: 5,
      date_created: "2025-05-23T10:00:00Z",
      is_issue: false,
      images: [
        "https://i0.wp.com/w42st.com/wp-content/uploads/2022/05/IMG_4764-sailors-intrepid-fleet-week-2019.jpg?resize=1536%2C1060&ssl=1",
      ],
      title: "Fleet Week New York 2025",
      lat_location: 40.7648,
      long_location: -73.9903,
      address: "Pier 88, New York, NY 10019",
      borough: "Manhattan",
      zipcode: "10019",
      email: "fleetweek@example.com",
      phone: "555-555-1515",
      status: true,
      description:
        "Celebrate America's sea services with ship tours, military demonstrations, and more during Fleet Week.",
    },
    {
      id: 16,
      user_id: 6,
      ...
      title: "9th Avenue International Food Festival",
      lat_location: 40.7638,
      long_location: -73.9918,
      address: "9th Ave between 42nd & 57th St, New York, NY",
      borough: "Manhattan",
      zipcode: "10019",
      email: "foodfest@example.com",
      phone: "555-555-1616",
      status: false, // Canceled or postponed
      description:
        "Experience international cuisines and entertainment at NYC's oldest and largest food festival.",
    },
    {
      id: 17,
      user_id: 7,
      date_created: "2025-05-23T12:00:00Z",
      is_issue: false,
      images: [
        "https://www.asaseyaaent.org/wp-content/uploads/2018/11/home_10.15.00-1080x675.jpg",
      ],
      title: "DanceAfrica Festival 2025",
      lat_location: 40.6888,
      long_location: -73.9786,
      address: "BAM Howard Gilman Opera House, Brooklyn, NY 11217",
      borough: "Brooklyn",
      zipcode: "11217",
      email: "danceafrica@example.com",
      phone: "555-555-1717",
      status: true,
      description:
        "Celebrate African diasporic dance and music with performances, workshops, and an outdoor bazaar.",
    },
    {
      id: 18,
      user_id: 8,
      date_created: "2025-05-24T10:00:00Z",
      is_issue: false,
      images: [
        "https://images.303magazine.com/uploads/2021/07/VanGoghAlive_303MAG_MarlaKeown_0019.jpg",
      ],
      title: "Van Gogh's Flowers Exhibition",
      lat_location: 40.8623,
      long_location: -73.8801,
      address: "New York Botanical Garden, Bronx, NY 10458",
      borough: "Bronx",
      zipcode: "10458",
      email: "vangoghflowers@example.com",
      phone: "555-555-1818",
      status: true,
      description:
        "Explore a floral show inspired by Van Gogh's masterpieces, featuring vibrant botanical displays.",
    },
    {
      id: 19,
      user_id: 9,
      date_created: "2025-05-27T18:30:00Z",
      is_issue: false,
      images: [
        "https://eastharlemalliance.org/wp-content/uploads/2025/05/Untitled-design-53-Randalls-Island-Park-Alliance.png",
      ],
      title: "Yoga in the Park",
      lat_location: 40.7931,
      long_location: -73.9225,
      address: "Randall's Island Park, New York, NY 10035",
      borough: "Manhattan",
      zipcode: "10035",
      email: "yogapark@example.com",
      phone: "555-555-1919",
      status: true,
      description:
        "Join a free outdoor yoga session suitable for all levels, set against the uptown skyline.",
    },
    {
      id: 20,
      user_id: 10,
      date_created: "2025-05-28T09:30:00Z",
      is_issue: false,
      images: [
        "https://www.grownyc.org/images/ospace/plantalot/randalls.500.jpg",
      ],
      title: "Team RIVER Volunteers",
      lat_location: 40.7931,
      long_location: -73.9225,
      address: "Randall's Island Park, New York, NY 10035",
      borough: "Manhattan",
      zipcode: "10035",
      email: "teamriver@example.com",
      phone: "555-555-2020",
      status: false, // Volunteer event not currently open
      description:
        "Help restore and care for natural spaces on Randall's Island with the Team RIVER Volunteers.",
    },
  ];
